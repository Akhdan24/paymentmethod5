...
void main() {
  runApp(MaterialApp(home: paymentmethodbni()));
}

class paymentmethodbni extends StatefulWidget {
  @override
  State<paymentmethodbni> createState() => _paymentmethodbniState();
}

class _paymentmethodbniState extends State<paymentmethodbni>
    with SingleTickerProviderStateMixin {
  int timeLeft = 1;
  final int harga = 16500;
  final int proteksi = 15400;
  final int asuransi = 1500;
  String bank = "BNI Virtual Account";
  String assets = "assets/bni.png";
                          ...
                          Container(
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 300,
                                    child: Text("Masukkan Kartu ATM anda",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text("Masukkan PIN ATM anda",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text(
                                        "Masukkan Nomor Virtual Account anda (contoh: 8808988556620621)",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text(
                                        "Setalah transaksi anda selsai, invoice ini akan diupdate secara otomatis. Proses ini mungkin memakan waktu hingga 5 menit",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 300,
                                    child: Text(
                                        "Akses BNI Mobile Bamking melalui handphone",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 300,
                                    child: Text(
                                        "Masukkan Nomor Virtual Account anda (contoh: 8808988556620621) pada menu 'Input Baru'",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 328,
                                    child: Text(
                                        "Buka situs http://ibank.bni.co.id",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text(
                                        "Masukkan Nomor Virtual Account (contoh: 8808988556620621)",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
