...
void main() {
  runApp(MaterialApp(home: paymentmethodbri()));
}

class paymentmethodbri extends StatefulWidget {
  @override
  State<paymentmethodbri> createState() => _paymentmethodbriState();
}

class _paymentmethodbriState extends State<paymentmethodbri>
    with SingleTickerProviderStateMixin {
  int timeLeft = 1;
  final int harga = 16500;
  final int proteksi = 15400;
  final int asuransi = 1500;
  String bank = "BRI Virtual Account";
  String assets = "assets/bri.png";
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text(
                                        "Masukkan Nomor Virtual Account (contoh: 92001988572642231) dan jumlah yang ingin anda bayarkan",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text(
                                        "Setalah transaksi anda selesai, invoice ini akan diupdate secara otomatis. Proses ini mungkin memakan waktu hingga 5 menit",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 300,
                                    child: Text(
                                        "Masukkan Nomor Virtual Account anda (contoh: 92001988572642231) dan jumlah yang ingin anda bayarkan",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 328,
                                    child: Text(
                                        "Buka situs http://ib.bri.co.id/ib-bri/, dan masukkan USER ID dan PASSWORD anda",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
                            ...
                            child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: 300,
                                    child: Text(
                                        "Masukkan Nomor Virtual Account (contoh: 920011988572642231)",
                                        style: GoogleFonts.poppins().copyWith(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w500,
                                            color: Colors.black54)),
